...
build:$(SOURCE_PATH)utils.o $(SOURCE_PATH)command.o $(SOURCE_PATH)shell.o $(SOURCE_PATH)builtin.o
	$(CXX) $(CXXFLAGS) main.cpp $^ -o  $(EXE)

$(SOURCE_PATH)command.o: $(SOURCE_PATH)utils.o $(SOURCE_PATH)command.cpp
